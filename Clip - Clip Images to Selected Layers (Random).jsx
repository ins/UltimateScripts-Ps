...
Loads images IN RANDOM ORDER from the preselected folder
...
app.activeDocument.suspendHistory("Clip Images to Selected Layers (Random)", "main(imgDir)");
...
function main(inputFolder) {
	...
	var files = shuffle(getFilesFromFolder(inputFolder));
